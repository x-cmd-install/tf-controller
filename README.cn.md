...
[![x-cmd/install — tf-controller Code Quality Monitoring Repo Card](https://repo.x-cmd.io/tf-controller.svg?lang=zh)](https://x-cmd.com/install/tf-controller)
...
_数据快照: `data/card/260922.yml` · 2026-09-22T04:41:07Z._
